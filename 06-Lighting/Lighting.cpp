...
class MyApp : public App {
    ...
    public:
        void init(){
            ...
            plane.setup();
            plane.setKa(glm::vec3(0.2f, 0.2f, 0.2f));
            plane.setKd(glm::vec3(0.5f, 0.5f, 0.5f));
            ...
            sphere.setup();
            sphere.setKa(glm::vec3(0.2f, 0.0f, 0.0f));
            sphere.setKd(glm::vec3(0.5f, 0.0f, 0.0f));
            ...
            torus.setup();
            torus.setKa(glm::vec3(0.0f, 0.0f, 0.2f));
            torus.setKd(glm::vec3(0.0f, 0.0f, 0.5f));
        ...
        void display(){
            ...
            sphere.setCameraPosition(cameraPosition);
            ...
            torus.setCameraPosition(cameraPosition);
